    ...
    return function(req, res, next) {
        ...
        res.render = function(name, options, fn) {
            ...
            if (layout === true || layout === undefined) {
                ...
                layout = G.app.get('template_path') + '/' + layout;
            }
            // layout
            if (layout) {
                ...
                _render(name, options, function(err, body) {
                    ...
                    //var root = req.app.get('views') || process.cwd() + '/views';//TODO
                    root = name.split("/")[0] || process.cwd() + '/views';
 ...
 * has been registered.
 * @param {string} ext
 * @returns {register|render.render.render|register.render.render}
 */
 ...
 * @param {string} view
 * @param {string} ext
 * @returns {View|_L1.exports.require|module.exportsSemVer.require|Function.require}
 */
